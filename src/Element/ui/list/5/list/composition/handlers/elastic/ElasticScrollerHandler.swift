...
class ElasticScrollerHandler5:ScrollHandler,ElasticDecorator{
    /**
...
//        Swift.print("ElasticScrollerHandler5.onScrollWheelChange")
        ...
        (self as Elastic5).setProgress2(p)
    }
    /**
    ...
    override func onInDirectScrollWheelChange(_ event: NSEvent) {}//we must override this or else we get a too loose elastic effect.
}
