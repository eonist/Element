...
class SkinModifier {
    ...
    class func float(skin:Skin){// :TODO: rename since it floats and clears which are two methods, position? // :TODO: move to ElementModifier
        ...
        var index:Int = parent.subviews
            //contains(skin.element as! NSView) ? Utils.elementIndex(parent, skin.element) : elements.count/*The index of skin, This creates the correct index even if its not added to the parent yet*/
