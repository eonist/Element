...
class StylePropertyAsserter {
    ...
    static func hasGradient(_ skin:ISkin,_ depth:Int = 0)->Bool {
        let value = StylePropertyParser.value(skin, CSSConstants.fill.rawValue,depth)
    ...
    static func hasAsset(_ skin:ISkin,_ depth:Int = 0)->Bool {
        return StylePropertyParser.value(skin, CSSConstants.fill.rawValue,depth) is [Any]
    }
    static func hasDropShadow(_ skin:ISkin,_ depth:Int = 0)->Bool {
        let value = StylePropertyParser.value(skin, CSSConstants.drop_shadow.rawValue,depth)
