...
- Library of example code for each component in Element: [here](https://github.com/stylekit/explorer) and 
- macOS styles to get you started: [here](https://github.com/stylekit/ElCapitan)  
