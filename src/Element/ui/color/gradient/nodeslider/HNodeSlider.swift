...
class HNodeSlider:Element,INodeSlider {
    ...
    func onStartNodeDown() {
        ...
        if(mouseMoveHandler == nil){mouseMoveHandler = NSEvent.addLocalMonitorForEvents(matching:[.leftMouseDragged], handler:onStartNodeMove)}//we add a global mouse move event listener
    ...
    func onEndNodeDown() {
        ...
        if(mouseMoveHandler == nil) {mouseMoveHandler = NSEvent.addLocalMonitorForEvents(matching: [.leftMouseDragged], handler:onEndNodeMove)}//we add a global mouse move event listener
        else{fatalError("should not be possible")}
    }
...
private class Utils{
	 ...
	 */
	static func nodePosition(_ progress:CGFloat, _ width:CGFloat, _ nodeWidth:CGFloat)->CGFloat {
	 ...
	 */
	static func progress(_ mouseX:CGFloat,_ tempNodeMouseX:CGFloat,_ width:CGFloat,_ nodeWidth:CGFloat)->CGFloat {
