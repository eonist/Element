...
One more thing...Element supports **multiple layers** of CSS3 styles. Meaning you can create any design you want (think layered gradients in illustrator etc). Stay tuned.
