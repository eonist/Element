...
class ListParser {
     ...
     */
    static func label(_ list: DEPRECATED_IList, _ dataProviderItem:Dictionary<String,String>) -> NSView {// :TODO: rename to toItem and maybe move to Listparser, dataProviderItemToItem? ListUtils
     ...
     */
    static func labelAt(_ list: DEPRECATED_IList, _ index:Int)->NSView? {
     ...
     */
    static func dataProviderItem(_ list: DEPRECATED_IList, _ view:NSView)->Dictionary<String,String>? {
     ...
     */
    static func index(_ list: DEPRECATED_IList, _ view:NSView)->Int {
        return list.lableContainer!.indexOf(view)
    }
    /**
     * Returns the title of the currently selected
     */
    static func selectedTitle(_ list: DEPRECATED_IList)->String {
     ...
     */
    static func titleAt(_ list: DEPRECATED_IList, _ index:Int)->String{
        return list.dataProvider.getItemAt(index)!["title"]!
    }
    /**
     * Returns the title of the currently selected
     */
    static func selectedProperty(_ list: DEPRECATED_IList)->String {/*<--could be*/
        let index:Int = selectedIndex(list)
     ...
     */
    static func propertyAt(_ list: DEPRECATED_IList, _ index:Int)->String{
        return list.dataProvider.getItemAt(index)!["property"]!
    }
    /**
     * Returns the index of the currentSelected
     */
    static func selectedIndex(_ list: DEPRECATED_IList) -> Int {
     ...
     */
    static func selected(_ list: DEPRECATED_IList) -> ISelectable? {
     ...
     */
    static func itemsHeight(_ list: DEPRECATED_IList) -> CGFloat {
