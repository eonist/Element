...
class Switch:HSlider,ICheckable{
    ...
    func setChecked(_ isChecked:Bool) {
        ...
        if(self.isChecked && !isChecked){
            ...
            bgProgressAnimator = Animator(Animation.sharedInstance,0.6,1,0,bgProgressAnim,Linear.ease)/*Animate setProgress from 1 - 0*/
            ...
            bgProgressAnimator = Animator(Animation.sharedInstance,0.6,0,1,bgProgressAnim,Linear.ease)/*Animate setProgress from 0 - 1*/
        }
