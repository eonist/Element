...
class SlideableUtils {
    /**
     * Scrolls the list to a scalar position (value 0-1)
     */
    static func scrollTo(_ list:ISlidable,_ progress:CGFloat){
        let y:CGFloat = SlideableUtils.scrollTo(progress, list.height, list.itemsHeight)
