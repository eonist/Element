...
class SkinModifier {
     ...
     * Aligns @param view
     */
    class func align(skin:ISkin, graphic:IBaseGraphic) {
        ...
        //ViewModifier.position(view, CGPoint(margin.left/* + offset.x*/, margin.top/* + offset.y*/));// :TODO: this is temp for testing
    }
}
