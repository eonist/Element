...
class CheckModifier {
     ...
     */
    static func unCheckAllExcept(_ exceptionItem:ICheckable, _ checkables:Array<ICheckable>) {// :TODO: refactor this function// :TODO: rename to unSelectAllExcept
        checkables.forEach {
     ...
     */
    static func removeCheckable(_ checkables:inout Array<ICheckable>, _ item:ICheckable)->ICheckable? {
