class Button:Element{
	...
	//continue here - do more research around how swift handles ui events. This url should help with the research: https://www.cocoacontrols.com/controls?language=2-swift&platform_id=mac-os-x
