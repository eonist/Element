...
class ElasticScrollFastList:FastList, ElasticScrollableFast {
    ...
    override func resolveSkin() {
        ...
        /*RubberBand*/
        let frame = (min:0,len:maskSize[dir])//CGRect(0,0,width,height)/*represents the visible part of the content *///TODO: could be ranmed to maskRect
        let itemsRect = (min:0,len:contentSize[dir])/*represents the total size of the content *///TODO: could be ranmed to contentRect
