...
A Programmatic UI is great because everything is in swift code. Which makes your app simpler to version control. Twitter's [TWUI](https://github.com/twitter/twui) is another example of a similar framework.
