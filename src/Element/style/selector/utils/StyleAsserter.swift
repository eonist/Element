...
class StyleAsserter {
     ...
     */
    static func direct(_ stack:Array<ISelector>,_ style:IStyle)->Bool {//TODO: rename to isDirect, is it Necessary? StyleAsserter.direct is pretty self explanatory
