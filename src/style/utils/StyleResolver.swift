...
class StyleResolver{
    ...
    static func style(element:IElement)->IStyle{
        ...
        let styles = element as? Text != nil ? StyleManager.styles : Utils.getStyles(querrySelectors.last!)
        ...
        func getStyle(styleName:String)->IStyle?{for style in styles{if(style.name == styleName){return style}};return nil;}
