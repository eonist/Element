...
Element is a programatic UI framework for OSX. Features: Live reload, SVG & CSS support, 60FPS Interactive animation, 100% Swift. More information in the [Wiki](https://github.com/eonist/Element/wiki) and Q&A via  [Gitter](https://gitter.im/eonistic/element) 
