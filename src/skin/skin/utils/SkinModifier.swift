...
class SkinModifier {
     ...
     * Aligns @param view
     */
    class func align(skin:ISkin, _ decoratable:IGraphicDecoratable) {
        ...
        decoratable.setPosition(CGPoint(margin.left/* + offset.x*/, margin.top/* + offset.y*/))// :TODO: this is temp for testing
    }
}
