...
class StylePropertyParser{
    ...
    */
    ...
    class func lineOffsetType(skin:ISkin) -> OffsetType {
        ...
        if(offsetType.top = OffsetType.center || offsetType.bottom = OffsetType.center || offsetType.top = OffsetType.left || offsetType.top = OffsetType.right){fatalError("lineOffsetType:center is not supported yet")}
        return offsetType;
    }
    /**
